...
import { AdminTradeOperations } from '@/components/admin/AdminTradeOperations';
...
import { ArrowLeft, Settings, CreditCard, Users, Shield, UserCog, Wrench, Package, ShieldCheck, Activity, RefreshCw, Filter, Brain, Zap, ListChecks } from 'lucide-react';
...
const Admin = () => {
  ...
  const navItems = [
    ...
    { id: 'operations', label: 'Trade Ops', icon: ListChecks, component: AdminTradeOperations },
